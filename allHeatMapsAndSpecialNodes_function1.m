...
filePreamble                             = '/rigel/stats/users/us2157/spines/results/heatMaps/jul28_1Percent_heatMapsAndSpecialNodes_';
synType                                  = {'spine', 'IS'};
...
for kk = 1:numel(synType1)
  ...
  for tr = 1:numel(trees)
    ...
    if lambda > 16/100 %70
      ...
      if ~isempty(synType2{kk})
        plotHeatMapAndSpecialNodes1(trees{tr}, allMu, cell2mat(xyzOfNodesOfInterest2{tr}'));
        ...
        plotHeatMapAndSpecialNodes1(trees{tr}, allMu, []);
