function eiBalanceHeatMap_fullRange
...
filePreamble                             = '/rigel/stats/users/us2157/spines/results/heatMaps/eiBalanceHeatMap_fullRange_';
...
for kk = 1:numel(synType1)
  ...
  for tr = 1:numel(trees)
	...
	for mm = 1:size(trees{tr}{bb}{4}{1},1)
      ...
      text(miniX-100, miniY-40,'-1','FontSize',16); text(miniX-20, miniY-40,'1','FontSize',16);
